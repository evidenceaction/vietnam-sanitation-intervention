...
\title{Identification of the Effect of Deworming Using Administrative Boundaries}
...
plot(deworm.district.adm, border="grey")
plot(deworm.prov.adm, add=TRUE)
...
\section*{Heterogeneity of Impact}
